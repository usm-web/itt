...
class HtmlTest extends PHPUnit_Framework_TestCase {
	...
	public function testGeneratingLink()
	{
		...
		$this->assertEquals('<a href="http://localhost/index.blade.php/foo">http://localhost/index.blade.php/foo</a>', $html1);
		$this->assertEquals('<a href="http://localhost/index.blade.php/foo">Foobar</a>', $html2);
		$this->assertEquals('<a href="http://localhost/index.blade.php/foo" class="btn">Foobar</a>', $html3);
	...
	public function testGeneratingLinkToSecure()
	{
		...
		$this->assertEquals('<a href="https://localhost/index.blade.php/foo">https://localhost/index.blade.php/foo</a>', $html1);
		$this->assertEquals('<a href="https://localhost/index.blade.php/foo">Foobar</a>', $html2);
		$this->assertEquals('<a href="https://localhost/index.blade.php/foo" class="btn">Foobar</a>', $html3);
		$this->assertEquals('<a href="http://google.com">Google</a>', $html4);
	}
	...
	public function testGeneratingLinkToRoute()
	{
		...
		$this->assertEquals('<a href="http://localhost/index.blade.php/dashboard">http://localhost/index.blade.php/dashboard</a>', $html1);
		$this->assertEquals('<a href="http://localhost/index.blade.php/dashboard">Foobar</a>', $html2);
		$this->assertEquals('<a href="http://localhost/index.blade.php/dashboard" class="btn">Foobar</a>', $html3);
	}
	...
	public function testGeneratingLinkToAction()
	{
		...
		$this->assertEquals('<a href="http://localhost/index.blade.php/foo/bar">http://localhost/index.blade.php/foo/bar</a>', $html1);
		$this->assertEquals('<a href="http://localhost/index.blade.php/foo/bar">Foobar</a>', $html2);
		$this->assertEquals('<a href="http://localhost/index.blade.php/foo/bar" class="btn">Foobar</a>', $html3);
	}
