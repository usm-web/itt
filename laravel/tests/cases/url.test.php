...
class URLTest extends PHPUnit_Framework_TestCase {
	...
	{
		$this->assertEquals('http://localhost/index.blade.php/user/profile', URL::to('user/profile'));
		$this->assertEquals('https://localhost/index.blade.php/user/profile', URL::to('user/profile', true));
	...
	public function testToActionMethodGeneratesURLToControllerAction()
	{
		...
		$this->assertEquals('http://localhost/index.blade.php/x/y', URL::to_action('x@y'));
		$this->assertEquals('http://localhost/index.blade.php/x/y/Taylor', URL::to_action('x@y', array('Taylor')));
		$this->assertEquals('http://localhost/index.blade.php/foo/bar', URL::to_action('foo@baz'));
		$this->assertEquals('http://localhost/index.blade.php/foo/bar/Taylor', URL::to_action('foo@baz', array('Taylor')));
	}
	...
	public function testToRouteMethodGeneratesURLsToRoutes()
	{
		...
		$this->assertEquals('http://localhost/index.blade.php/url/test', URL::to_route('url-test'));
		$this->assertEquals('http://localhost/index.blade.php/url/test/taylor', URL::to_route('url-test-2', array('taylor')));
		$this->assertEquals('https://localhost/index.blade.php/url/secure/taylor', URL::to_route('url-test-3', array('taylor')));
		$this->assertEquals('http://localhost/index.blade.php/url/test/taylor/otwell', URL::to_route('url-test-2', array('taylor', 'otwell')));
	}
	...
	public function testUrlsGeneratedWithLanguages()
	{
		...
		$this->assertEquals('http://localhost/index.blade.php/sp/foo', URL::to('foo'));
		...
		$this->assertEquals('http://localhost/index.blade.php/foo', URL::to('foo'));
