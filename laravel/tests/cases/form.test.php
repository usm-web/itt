...
class FormTest extends PHPUnit_Framework_TestCase {
	...
	public function setUp()
	{
		...
		Config::set('application.index', 'index.blade.php');
	}
	/**
	...
	public function testOpeningForm()
	{
		...
		$this->assertEquals('<form method="GET" action="http://localhost/index.blade.php/foobar" accept-charset="UTF-8">', $form1);
		$this->assertEquals('<form method="POST" action="http://localhost/index.blade.php/foobar" accept-charset="UTF-8">', $form2);
		$this->assertEquals('<form accept-charset="UTF-16" class="form" method="POST" action="http://localhost/index.blade.php/foobar"><input type="hidden" name="_method" value="PUT">', $form3);
		$this->assertEquals('<form class="form" method="POST" action="http://localhost/index.blade.php/foobar" accept-charset="UTF-8"><input type="hidden" name="_method" value="DELETE">', $form4);
	}
	...
	public function testOpeningFormSecure()
	{
		...
		$this->assertEquals('<form method="GET" action="https://localhost/index.blade.php/foobar" accept-charset="UTF-8">', $form1);
		$this->assertEquals('<form method="POST" action="https://localhost/index.blade.php/foobar" accept-charset="UTF-8">', $form2);
		$this->assertEquals('<form accept-charset="UTF-16" class="form" method="POST" action="https://localhost/index.blade.php/foobar"><input type="hidden" name="_method" value="PUT">', $form3);
		$this->assertEquals('<form class="form" method="POST" action="https://localhost/index.blade.php/foobar" accept-charset="UTF-8"><input type="hidden" name="_method" value="DELETE">', $form4);
	}
	...
	public function testOpeningFormForFile()
	{
		...
		$this->assertEquals('<form enctype="multipart/form-data" method="GET" action="http://localhost/index.blade.php/foobar" accept-charset="UTF-8">', $form1);
		$this->assertEquals('<form enctype="multipart/form-data" method="POST" action="http://localhost/index.blade.php/foobar" accept-charset="UTF-8">', $form2);
		$this->assertEquals('<form accept-charset="UTF-16" class="form" enctype="multipart/form-data" method="POST" action="http://localhost/index.blade.php/foobar"><input type="hidden" name="_method" value="PUT">', $form3);
		$this->assertEquals('<form class="form" enctype="multipart/form-data" method="POST" action="http://localhost/index.blade.php/foobar" accept-charset="UTF-8"><input type="hidden" name="_method" value="DELETE">', $form4);
	}
	...
	public function testOpeningFormSecureForFile()
	{
		...
		$this->assertEquals('<form enctype="multipart/form-data" method="GET" action="https://localhost/index.blade.php/foobar" accept-charset="UTF-8">', $form1);
		$this->assertEquals('<form enctype="multipart/form-data" method="POST" action="https://localhost/index.blade.php/foobar" accept-charset="UTF-8">', $form2);
		$this->assertEquals('<form accept-charset="UTF-16" class="form" enctype="multipart/form-data" method="POST" action="https://localhost/index.blade.php/foobar"><input type="hidden" name="_method" value="PUT">', $form3);
		$this->assertEquals('<form class="form" enctype="multipart/form-data" method="POST" action="https://localhost/index.blade.php/foobar" accept-charset="UTF-8"><input type="hidden" name="_method" value="DELETE">', $form4);
	}
