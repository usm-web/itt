...
/**
 * We will register all of the Laravel provided ittasks inside the IoC
 * container so they can be resolved by the task class. This allows
 * us to seamlessly add ittasks to the CLI so that the Task class
 * doesn't have to worry about how to resolve core ittasks.
 */
